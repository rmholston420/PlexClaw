...
def _read_required(path_str: str) -> str:
    path = Path(path_str)
    assert path.exists(), f"Missing Playwright scaffold file: {path_str}"
    return path.read_text()


def test_playwright_package_manifest_exists() -> None:
    text = _read_required("frontend/package.json")
...
def test_playwright_config_exists() -> None:
    text = _read_required("frontend/playwright.config.mjs")
...
def test_playwright_smoke_spec_exists() -> None:
    text = _read_required("frontend/e2e/smoke.spec.js")
...
def test_playwright_tabs_spec_exists() -> None:
    text = _read_required("frontend/e2e/tabs.spec.js")
...
def test_playwright_controls_spec_exists() -> None:
    text = _read_required("frontend/e2e/controls.spec.js")
...
def test_playwright_exports_spec_exists() -> None:
    text = _read_required("frontend/e2e/exports.spec.js")
    assert (
...
def test_playwright_runtime_mode_spec_exists() -> None:
    text = _read_required("frontend/e2e/runtime-mode.spec.js")
...
def test_playwright_tool_search_spec_exists() -> None:
    text = _read_required("frontend/e2e/tool-search.spec.js")
...
def test_playwright_session_utils_spec_exists() -> None:
    text = _read_required("frontend/e2e/session-utils.spec.js")
...
def test_playwright_composer_spec_exists() -> None:
    text = _read_required("frontend/e2e/composer.spec.js")
...
def test_playwright_archive_spec_exists() -> None:
    text = _read_required("frontend/e2e/archive.spec.js")
...
def test_playwright_terminal_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal.spec.js")
...
def test_playwright_search_modal_spec_exists() -> None:
    text = _read_required("frontend/e2e/search-modal.spec.js")
...
def test_playwright_search_modal_diagnostic_spec_exists() -> None:
    text = _read_required("frontend/e2e/search-modal-diagnostic.spec.js")
...
def test_playwright_cwd_modal_spec_exists() -> None:
    text = _read_required("frontend/e2e/cwd-modal.spec.js")
...
def test_playwright_modal_escape_spec_exists() -> None:
    text = _read_required("frontend/e2e/modal-escape.spec.js")
...
def test_playwright_modal_backdrop_spec_exists() -> None:
    text = _read_required("frontend/e2e/modal-backdrop.spec.js")
...
def test_playwright_tab_activation_spec_exists() -> None:
    text = _read_required("frontend/e2e/tab-activation.spec.js")
...
def test_playwright_search_focus_spec_exists() -> None:
    text = _read_required("frontend/e2e/search-focus.spec.js")
...
def test_playwright_terminal_toggle_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal-toggle.spec.js")
...
def test_playwright_export_controls_tabs_spec_exists() -> None:
    text = _read_required("frontend/e2e/export-controls-tabs.spec.js")
    assert (
        "test('export controls remain visible and enabled across tab changes'" in text
    )
    assert "#new-tab-btn" in text
    assert "#export-session" in text
    assert "#export-session-json" in text
...
def test_playwright_search_close_spec_exists() -> None:
    text = _read_required("frontend/e2e/search-close.spec.js")
...
def test_playwright_terminal_toolbar_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal-toolbar.spec.js")
    assert (
...
def test_playwright_archive_search_spec_exists() -> None:
    text = _read_required("frontend/e2e/archive-search.spec.js")
    assert (
...
def test_playwright_cwd_actions_spec_exists() -> None:
    text = _read_required("frontend/e2e/cwd-actions.spec.js")
...
def test_playwright_terminal_errors_filter_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal-errors-filter.spec.js")
    assert (
...
def test_playwright_search_shortcut_spec_exists() -> None:
    text = _read_required("frontend/e2e/search-shortcut.spec.js")
    assert (
        "test('Ctrl/Cmd+F opens the search modal and focuses the search input'" in text
    )
    assert "#search-modal" in text
...
def test_playwright_tab_scroll_spec_exists() -> None:
    text = _read_required("frontend/e2e/tab-scroll.spec.js")
    assert (
        "test('tab scroll controls remain visible after creating multiple tabs'" in text
    )
...
def test_playwright_archive_refresh_spec_exists() -> None:
    text = _read_required("frontend/e2e/archive-refresh.spec.js")
    assert (
...
def test_playwright_terminal_copy_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal-copy.spec.js")
    assert (
        "test('terminal copy control remains usable after opening the drawer'" in text
    )
    assert "openTerminalDrawer" in text
    assert "gotoMainUi" in text
    assert "terminalDrawer" in text
...
def test_playwright_terminal_clear_spec_exists() -> None:
    text = _read_required("frontend/e2e/terminal-clear.spec.js")
    assert (
        "test('terminal clear control remains usable after opening the drawer'" in text
    )
    assert "openTerminalDrawer" in text
    assert "gotoMainUi" in text
    assert "terminalDrawer" in text
